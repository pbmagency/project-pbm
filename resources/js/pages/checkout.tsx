                    ...
                    <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
                        ...
                        <div className="rounded-2xl border border-lp-border bg-lp-bg-elevated p-7 sm:p-9">
                            ...
                            <p className="mt-1 text-sm text-lp-text-muted">
                                Detail event & akses digital dikirim otomatis ke
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-lp-border bg-lp-bg px-4 py-3 text-sm text-lp-text placeholder-lp-text-dim transition outline-none focus:border-lp-primary focus:ring-2 focus:ring-lp-primary/20"
                                    />
                                    {errors.name && (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="rounded-2xl border border-lp-border bg-lp-bg-elevated p-6">
                                ...
                                <h2 className="mt-3 font-display text-lg leading-snug font-bold text-lp-text">
                                ...
                                <ul className="mt-4 space-y-2">
                                    {[
                                        ...
                                        <li
                                            key={item}
                                            className="flex items-start gap-2 text-sm text-lp-text-muted"
                                        >
                                ...
                                <div className="mt-5 border-t border-lp-border pt-5">
                                    ...
                                    <div className="mt-3 flex items-center justify-between font-display font-bold">
                                        ...
                                        <span className="text-xl text-lp-text">
                                            {formatRupiah(price)}
                                        </span>
                                    </div>
                                </div>
                            ...
                            {/* Trust badges */}
                            <div className="space-y-3 rounded-2xl border border-lp-border bg-lp-bg-elevated p-5">
                                {[
                                    {
                                        icon: Users,
                                        label: 'Dipercaya 100+ Bisnis',
                                    },
                                    {
                                        icon: Star,
                                        label: 'Rating 4.9/5 dari peserta',
                                    },
                                    {
                                        icon: Shield,
                                        label: 'Garansi kepuasan 100%',
                                    },
                                    {
                                        icon: MessageCircle,
                                        label: 'Detail event dikirim otomatis via email',
                                    },
                                ].map(({ icon: Icon, label }) => (
                                    <div
                                        key={label}
                                        className="flex items-center gap-3 text-sm text-lp-text-muted"
                                    >
