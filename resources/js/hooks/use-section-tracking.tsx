 ...
 *
 * Replaces the old per-section `useSectionView(id)` hook: instead of wrapping
 * every section component in its own hook + ref, call this once at the page
 * level and just add `id="..."` to each `<section>` tag.
 */
export function useSectionTracking() {
    ...
    useEffect(() => {
         ...
         * arriving via React.lazy/Suspense).
         */
