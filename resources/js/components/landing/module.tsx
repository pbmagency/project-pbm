...
export function Module() {
    ...
    return (
        <section
            id="module"
            ref={ref}
            className="border-b border-lp-border-soft bg-lp-bg"
        >
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24 lg:py-28">
                ...
                <h2 className="mt-5 text-3xl font-extrabold tracking-tight text-lp-text sm:text-4xl">
                    Apa yang Sebenarnya Dibedah
                </h2>

                <p className="mt-4 max-w-[60ch] text-lg text-lp-text-muted">
                        ...
                        <div
                            ...
                            className={cn(
                                ...
                                mod.amber
                                    ...
                                    : 'border-lp-border bg-lp-bg-elevated',
                            )}
                        >
                            <div
                                className={cn(
                            ...
                            <h3 className="mt-4 text-lg font-bold text-lp-text">
                                {mod.title}
                ...
                <div className="mt-9 rounded-[20px] border border-lp-border bg-lp-bg-elevated p-6 sm:p-8">
                    <p className="font-mono text-[11px] tracking-wide text-lp-text-dim uppercase">
                    ...
                    <div className="mt-4 flex flex-col gap-3.5">
                        {CYCLES.map((cycle, index) => (
                            ...
                            >
                                ...
                                {cycle.running ? (
                                    <span className="rounded-full border border-lp-primary px-2.5 py-1 font-mono text-[11px] tracking-wide text-lp-primary-ink uppercase">
                                        Sedang Berlangsung
                                    </span>
                                ) : (
                                    <>
