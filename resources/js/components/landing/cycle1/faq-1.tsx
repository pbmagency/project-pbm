        ...
        >
            ...
            <div className="relative mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:py-28">
                <div className="text-center">
                    {/* Updated Eyebrow to match the dark blue pill in the image */}
                    <div className="mx-auto inline-flex items-center rounded-full border border-lp-primary/30 bg-lp-primary-soft/10 px-4 py-1.5 font-mono text-[11px] font-bold tracking-wider text-lp-primary sm:text-xs">
                        FAQ
                    </div>
                    
                    <h2 className="mt-5 font-display text-3xl font-extrabold tracking-tight text-lp-text sm:text-4xl lg:text-5xl">
                        {/* whitespace-nowrap prevents it from breaking into two lines! */}
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <CollapsibleContent className="px-5.5 pb-5 text-[15px] leading-relaxed text-lp-text-muted">
                                        {faq.answer}
                                    </CollapsibleContent>
                                </div>
                            </Collapsible>
